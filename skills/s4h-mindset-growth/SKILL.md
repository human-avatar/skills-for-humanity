---
name: s4h-mindset-growth
description: "Applies Carol Dweck's growth mindset research as a practical methodology — the actual mechanics, not the motivational poster version. Use when you're treating failure as evidence about your identity, avoiding challenges because of what failure would mean, comparing yourself to others in a way that deflates rather than inspires, or struggling to persist in areas where you're not naturally good. Triggers: 'growth mindset', 'I hate not being good at things', 'failure feels personal', 'I avoid things I might fail at', 'I feel stupid when I struggle', 'fixed mindset', 'talent vs. effort'."
---
...
**Step 1: Identify the Fixed-Mindset Trigger**
Fixed mindset activates in specific, identifiable situations:
...
Examples:
- "If I struggle with this, it means I'm not smart enough to do this kind of work."
- "If I get this wrong after years of experience, it means I'm not as good as I thought."
- "If they find this easier than I do, it means I don't belong here."
- "If I have to put in this much effort, it means I lack the natural talent for this."
...
**Step 3: Examine the Belief**
Once surfaced, the belief can be tested:

- Is the conclusion (about fixed ability) the only interpretation of the evidence, or one of several?
- What is the evidence that abilities in this domain are actually fixed vs. developable?
- What would a person who had clearly developed this ability say about how they developed it? Were they always performing at that level?
- Does the difficulty of this specific challenge reveal anything about your *permanent* capability, or about your *current* level in a developing skill?

The key question: *Is this a verdict about what I am, or information about where I currently am?*

**Step 4: Reframe Through the Growth Lens**
Translate the fixed interpretation into its growth equivalent. This is not a verbal trick — it is a genuinely different interpretation that is equally or more consistent with the evidence.
...
**Step 5: Design the Learning Response**
Growth mindset produces a specific behavioral output: a concrete engagement with the challenge or failure as a learning signal.

- What specific skill or knowledge gap does the failure reveal?
- What is the smallest next step that engages that specific gap?
- What does deliberate practice in this area actually look like? (Not "practice more" — a specific, effortful, feedback-rich activity)
- How will you measure progress over a period where it is likely to be slow and non-linear?
...
- **Question:** "What's the challenge or failure you want to work through?"
- **Header:** "Growth Mindset"
- **Options:**
  - **Share the situation** — Describe what happened and run the full process
  - **Identify the trigger type** — Start by classifying what kind of fixed-mindset trigger is active
  - **Surface the belief** — Jump straight to naming the hidden fixed-mindset belief
  - **Design the learning response** — Skip diagnosis and go straight to what to do next
...
### The Trigger
**Situation:** [The specific challenge, failure, or comparison that activated the response]
**Trigger type:** Challenge / Failure / Comparison / Effort

### The Hidden Belief
**The fixed-mindset belief:** *"If [X], it means [fixed conclusion]."*
**Where it came from:** [The implicit logic — where this belief made sense, even if it doesn't hold up]

### Examining the Belief
**Evidence it rests on:** [What the person is using to support the conclusion]
**What the evidence actually shows:** [The more accurate interpretation — not forced positivity, but what the evidence actually supports]
**The verdict:** [Is this a verdict about what you are, or information about where you currently are?]

### The Growth Reframe
**Fixed interpretation:** [What was being believed]
**Growth interpretation:** [The equally-supported but developmental interpretation]
**Not yet:** [The "not yet" formulation for the specific belief — what cannot be done *yet*]

### The Learning Response
**What the failure/difficulty reveals:** [The specific gap — as precise as possible]
**The smallest next step:** [A concrete action that engages that specific gap]
**What deliberate practice looks like:** [The actual activity — not just "practice more"]
**Progress horizon:** [A realistic timeframe and what to expect]
...
- **Question:** "Growth mindset applied. What's next?"
- **Header:** "Next"
- **Options:**
  - `/s4h-identity-values-clarification` — Connect the growth orientation to underlying values
  - `/s4h-decision-premortem-analysis` — Stress-test plans with growth assumptions examined
  - `/s4h-emotional-resistance-diagnosis` — Diagnose resistance to the growth framing
