...
- **Options:** (build dynamically — 2–3 skill options plus a fallback)
  ...
  - Label: "More options", Description: "Show all skills in the [most relevant category] category"
...
- **More options:** Show the full skill table for the most relevant category. Let them pick from the complete list, then execute.
