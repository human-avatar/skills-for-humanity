---
name: s4h-ethics-consent-review
...
- **Header:** "Next"
- **Options:**
  - `/s4h-ethics-empathy-circle` — Apply empathy to those whose consent is in question
  - `/s4h-communication-audience-modeling` — Model how to communicate consent requirements
  - `/s4h-ethics-impact-scan` — Scan for impact on those whose consent was not obtained
