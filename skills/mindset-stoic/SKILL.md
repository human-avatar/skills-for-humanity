...
- **Header:** "Next"
- **Options:**
  - `/decision-premortem-analysis` — Apply stoic premeditation formally to the plan
  - `/decision-reversibility-analysis` — Assess reversibility with stoic detachment
  - `/emotional-resistance-diagnosis` — Diagnose resistance the stoic framing can address
