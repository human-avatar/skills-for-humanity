...
- **Header:** "Next"
- **Options:**
  - `/s4h-creativity-assumption-excavator` — Excavate assumptions the reframe challenged
  - `/s4h-narrative-frame-analysis` — Analyse the new frame itself
  - `/s4h-creativity-lateral-thinking` — Use the reframe as a lateral move springboard
