...
- **Header:** "Next"
- **Options:**
  - `/s4h-ethics-check` — Run a full ethical check of the vendor relationship
  - `/s4h-decision-criteria-weighting` — Weight vendor decision criteria on the ethical findings
  - `/s4h-ethics-data-audit` — Audit the vendor's data practices
