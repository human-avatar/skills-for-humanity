...
- **Header:** "Next"
- **Options:**
  - `/identity-values-clarification` — Connect the growth orientation to underlying values
  - `/decision-premortem-analysis` — Stress-test plans with growth assumptions examined
  - `/emotional-resistance-diagnosis` — Diagnose resistance to the growth framing
