---
name: s4h-resource-leverage-mapping
...
- **Header:** "Next"
- **Options:**
  - `/s4h-resource-allocation-analysis` — Reallocate resources to the leverage points
  - `/s4h-strategy-force-economy` — Deploy effort economically via the leverage found
  - `/s4h-systems-leverage-analysis` — Combine resource leverage with systems leverage
